...
<nav>
    <ul>
        ...
        <li class="sel" id="selected" onclick="location.href='${pageContext.request.contextPath}/plate'">Пластина</li>
...
<div class="tableRow">
    ...
    <button class="back" onclick="location.href='${pageContext.request.contextPath}/plates';" type="button" >Назад</button>
...
<script>
    ...
    $("#del").click(function () {
        ...
        window.location.href="${pageContext.request.contextPath}/deletePlate/".concat(${currentPlate.plateId});
        }
    })
    });
</script>
