...
<nav>
    <ul>
        ...
        <li class="sel" id="selected" onclick="location.href='${pageContext.request.contextPath}/addElementPage'">Добавить деталь</li>
...
<script src="${pageContext.request.contextPath}/resources/js/addElement.js"></script>
<script>
    function formSubmit() {
