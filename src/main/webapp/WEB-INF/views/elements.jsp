...
<nav>
    <ul>
        ...
        <li class="sel" id="selected" onclick="location.href='${pageContext.request.contextPath}/elements'">Детали</li>
...
<script src="${pageContext.request.contextPath}/resources/js/elements.js"></script>
<script>
    function formSubmit() {
