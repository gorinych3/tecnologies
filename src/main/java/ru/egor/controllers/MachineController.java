...
public class MachineController {
    ...
    @Autowired
    public MachineController(Gson gson, MachineService machineService, MyPathService myPathService, FileProperties properties) {
        this.gson = gson;
    ...
    Map<String, Object> fileUpload(MultipartHttpServletRequest request, HttpServletResponse response) {
        ...
        return machineService.fileUpload(request, response, properties.getMachinesPath());
    }
    ...
    public ResponseEntity<InputStreamResource> downloadMashineFile(@PathVariable String fileName) throws IOException {
        ...
        File file = new File(properties.getMachinesPath() + fileName + SUFFIX_PATH);
